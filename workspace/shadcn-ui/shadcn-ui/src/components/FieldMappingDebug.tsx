...
export default function FieldMappingDebug() {
  ...
  const [bulkResults, setBulkResults] = useState<BulkMappingResult | null>(null)
              ...
              <div className="space-y-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        {bulkResults.mappings.map((mapping: FieldMapping, index: number) => (
                ...
                {bulkResults.missingRequired.length > 0 && (
                  <Card>
                    ...
                    <CardContent>
                      <div className="flex flex-wrap gap-2">
                        {bulkResults.missingRequired.map((field: MLSFieldDefinition, index: number) => (
