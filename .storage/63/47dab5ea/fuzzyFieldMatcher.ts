...
export const MLS_FIELD_DEFINITIONS: MLSFieldDefinition[] = [
  ...
  },
  {
    ...
    variations: ['LivingArea', 'living area', 'square feet', 'sq ft', 'sqft', 'living_area', 'interior sqft', 'finished sqft', 'heated sqft'],
    required: true,
    dataType: 'number',
    category: 'basic'
  },
  ...
  },
  {
    ...
    variations: ['BathroomsPartial', 'bathrooms partial', 'partial bathrooms', 'partial baths', 'bathrooms_partial', 'partial_baths'],
    required: false,
    dataType: 'number',
    category: 'basic'
  },
  ...
  {
    standardName: 'LotSize',
    variations: ['LotSize', 'lot size', 'lot sqft', 'lot square feet', 'lot_size', 'land size', 'lot area'],
    required: true,
    dataType: 'number',
    category: 'basic'
  },
  {
    ...
    variations: ['LotSizeAcres', 'lot acres', 'lot size acres', 'acres', 'lot_acres', 'land acres'],
    required: false,
    dataType: 'number',
    category: 'basic'
  },
  ...
  },
  {
    ...
    variations: ['PoolFeatures', 'pool features', 'pool', 'swimming pool', 'pool type', 'pool_features', 'spa'],
    required: false,
    dataType: 'string',
    category: 'features'
  },
  {
    ...
    variations: ['FireplaceFeatures', 'fireplace features', 'fireplace', 'fireplaces', 'fireplace type', 'fireplace_features'],
    required: false,
    dataType: 'string',
    category: 'features'
  },
  {
    ...
    variations: ['KitchenFeatures', 'kitchen features', 'kitchen', 'kitchen amenities', 'kitchen_features', 'kitchen appliances'],
    required: false,
    dataType: 'string',
    category: 'features'
  },
  ...
  },
  {
    ...
    variations: ['LaundryFeatures', 'laundry features', 'laundry', 'laundry room', 'laundry_features', 'washer dryer'],
    required: false,
    dataType: 'string',
    category: 'features'
  },
  {
    ...
    variations: ['ConstructionMaterials', 'construction materials', 'exterior materials', 'building materials', 'construction_materials', 'siding'],
    required: false,
    dataType: 'string',
    category: 'features'
  },
  ...
  },
  {
    ...
    variations: ['FoundationDetails', 'foundation', 'foundation details', 'foundation type', 'foundation_details', 'basement'],
    required: false,
    dataType: 'string',
    category: 'features'
  },
  ...
  },
  {
    ...
    variations: ['HeatingType', 'heating', 'heating type', 'heat', 'heating system', 'heating_type', 'hvac'],
    required: false,
    dataType: 'string',
    category: 'features'
  },
  {
    ...
    variations: ['CoolingType', 'cooling', 'cooling type', 'air conditioning', 'ac', 'cooling_type', 'cooling system'],
    required: false,
    dataType: 'string',
    category: 'features'
  },
  ...
  },
  {
    ...
    variations: ['AssociationFee', 'hoa fee', 'association fee', 'hoa', 'homeowners association', 'association_fee', 'monthly fee'],
    required: false,
    dataType: 'number',
    category: 'financial'
  },
  {
    ...
    variations: ['BuyerAgentCompensation', 'buyer agent compensation', 'buyer commission', 'buyer_agent_compensation', 'commission'],
    required: false,
    dataType: 'number',
    category: 'financial'
  },
  {
    ...
    variations: ['SpecialAssessments', 'special assessments', 'assessments', 'special_assessments', 'special fees'],
    required: false,
    dataType: 'number',
    category: 'financial'
  },
  ...
  // Agent and Brokerage Information
  {
    ...
    variations: ['ListingAgentFullName', 'listing agent', 'agent name', 'listing_agent', 'agent', 'listing agent name'],
    required: true,
    dataType: 'string',
    category: 'agent'
  },
  ...
  },
  {
    ...
    variations: ['ListingAgentPhone', 'listing agent phone', 'agent phone', 'phone', 'listing_agent_phone', 'agent number'],
    required: true,
    dataType: 'string',
    category: 'agent'
  },
  {
    ...
    variations: ['ListingAgentEmail', 'listing agent email', 'agent email', 'email', 'listing_agent_email'],
    required: false,
    dataType: 'string',
    category: 'agent'
  },
  {
    ...
    variations: ['ListingOfficeName', 'listing office', 'brokerage', 'office name', 'listing_office', 'broker', 'company'],
    required: true,
    dataType: 'string',
    category: 'agent'
  },
  ...
  },
  {
    ...
    variations: ['ShowingInstructions', 'showing instructions', 'showing', 'showing_instructions', 'appointment instructions'],
    required: false,
    dataType: 'string',
    category: 'agent'
  },
  {
    ...
    variations: ['VirtualTourURL', 'virtual tour', 'tour url', 'virtual_tour', 'online tour', 'virtual tour url'],
    required: false,
    dataType: 'string',
    category: 'media'
  },
  {
    ...
    variations: ['VideoURL', 'video', 'video url', 'video_url', 'property video', 'listing video'],
    required: false,
    dataType: 'string',
    category: 'media'
  }
