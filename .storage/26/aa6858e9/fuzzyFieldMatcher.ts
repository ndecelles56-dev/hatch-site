...
export const MLS_FIELD_DEFINITIONS: MLSFieldDefinition[] = [
  ...
  },
  {
    ...
    aliases: ['bathrooms_full', 'full_baths', 'full_bathrooms', 'bathrooms', 'baths', 'bathroom_count', 'ba', 'full_bath'],
    required: true,
    dataType: 'number',
    category: 'property'
  },
  ...
  // Agent Information - Fixed structure with separate agent and office licenses
  {
